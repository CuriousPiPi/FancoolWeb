/* core.js
 * Phase 1 保守拆分：
 * 将原 fancool.js 全量内容粘贴到下方标记处，保持所有逻辑原样。
 * 后续阶段才会逐步把颜色、图表、布局、状态 UI 等代码迁至对应模块。
 */

/* ==== BEGIN ORIGINAL fancool.js CODE (paste everything from old app/static/js/fancool.js here) ==== */
